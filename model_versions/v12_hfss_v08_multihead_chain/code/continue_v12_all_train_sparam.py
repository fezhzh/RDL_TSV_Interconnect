# -*- coding: utf-8 -*-
"""Continue the v12 cascade model using all 150 train samples.

Run this file directly in VS Code. No command-line arguments are required.

This entry loads the current new-RDL/new-TSV v12 checkpoint, restores the
...
BASE_CHECKPOINT = BASE_RUN_DIR / "v08_connection_multihead_net.pt"
SHARED_TARGETS_CSV = BASE_RUN_DIR / "v08_shared_optimized_targets.csv"
OUTPUT_DIR = (
    PROJECT_ROOT
    / "model_versions"
    / "v12_hfss_v08_multihead_chain"
...
def main() -> None:
    ...
    (OUTPUT_DIR / "validation_archive.md").write_text(
        "\n".join(
            [
                "# v12 All-150 S-Parameter Continue Training",
                "",
