# -*- coding: utf-8 -*-
"""Continue the all-150 v12 cascade model for a fourth S-parameter-only round.

Run this file directly in VS Code. No command-line arguments are required.

This entry loads the third all-150 continuation checkpoint, restores the
...
BASE_RUN_DIR = (
    ...
    / "results"
    / "hfss_v08_symmetric_multihead_lhs150_50_connection2_all150_sparam_continue_round3"
)
...
OUTPUT_DIR = (
    ...
    / "v12_hfss_v08_multihead_chain"
    / "results"
    / "hfss_v08_symmetric_multihead_lhs150_50_connection2_all150_sparam_continue_round4"
)
...
def main() -> None:
    ...
    (OUTPUT_DIR / "validation_archive.md").write_text(
        "\n".join(
            [
                "# v12 All-150 S-Parameter Continue Training Round 4",
                "",
