# -*- coding: utf-8 -*-
"""Continue the all-150 v12 cascade model for a third S-parameter-only round.

Run this file directly in VS Code. No command-line arguments are required.

This entry loads the second all-150 continuation checkpoint, restores the
...
def main() -> None:
    ...
    (OUTPUT_DIR / "validation_archive.md").write_text(
        "\n".join(
            [
                "# v12 All-150 S-Parameter Continue Training Round 3",
                "",
