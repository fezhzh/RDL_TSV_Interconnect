...
OUT_DIR = "model_versions/v01_matlab_mat_models/results/TSV_model_compare"
LENGTH_PARAM = "htsv"
DEVICE_NAME = "TSV"
OUTPUT_PREFIX = "tsv"
...
def main():
    ...
    args = build_args()
    model_configs = [
        {"label": "mat2", "type": "matlab", "path": "model_versions/v01_matlab_mat_models/models/RDL_TSV_mat2", "prefix": "TSV_"},
        {"label": "mat4", "type": "matlab", "path": "model_versions/v01_matlab_mat_models/models/RDL_TSV_mat4", "prefix": "TSV_"},
    ]
