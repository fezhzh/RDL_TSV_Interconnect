...
def build_arg_parser():
    ...
    parser.set_defaults(
        ...
        out_dir="model_versions/v01_matlab_mat_models/results/RDL_Top_model_compare",
        length_param="lrdl",
        device_name="RDL_Top",
...
def main():
    ...
    model_configs = [
        {"label": "mat1", "type": "matlab", "path": "model_versions/v01_matlab_mat_models/models/RDL_TSV_mat1", "prefix": "RDL_Top_"},
        {"label": "mat2", "type": "matlab", "path": "model_versions/v01_matlab_mat_models/models/RDL_TSV_mat2", "prefix": "RDL_Top_"},
        {"label": "mat3", "type": "matlab", "path": "model_versions/v01_matlab_mat_models/models/RDL_TSV_mat3", "prefix": "RDL_Top_"},
        {"label": "mat4", "type": "matlab", "path": "model_versions/v01_matlab_mat_models/models/RDL_TSV_mat4", "prefix": "RDL_Top_"},
    ]
