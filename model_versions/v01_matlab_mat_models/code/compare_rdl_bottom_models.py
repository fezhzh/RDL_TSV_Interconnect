...
def build_arg_parser():
    ...
    parser.add_argument("--out-dir", default="model_versions/v01_matlab_mat_models/results/RDL_Bottom_model_compare")
...
def main():
    ...
    model_configs = [
        {"label": "mat1", "type": "matlab", "path": "model_versions/v01_matlab_mat_models/models/RDL_TSV_mat1"},
        {"label": "mat2", "type": "matlab", "path": "model_versions/v01_matlab_mat_models/models/RDL_TSV_mat2"},
        {"label": "mat3", "type": "matlab", "path": "model_versions/v01_matlab_mat_models/models/RDL_TSV_mat3"},
        {"label": "mat4", "type": "matlab", "path": "model_versions/v01_matlab_mat_models/models/RDL_TSV_mat4"},
        {
            "label": "new_s_finetuned",
            "type": "torch",
            "path": "model_versions/v99_legacy_and_shared/results/RDL_Bottom_TD4_trend_sparam_training",
